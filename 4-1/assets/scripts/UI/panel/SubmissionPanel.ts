...
export default class SubmissionPanel extends BaseUI {
    ...
    //添加答案信息
    AddNet(gameDataJson) {
        let data = { title_id: NetWork.titleId, courseware_content: gameDataJson, is_result: 1, is_lavel: 0, lavel_num: 1 };
    ...
    ModifyNet(gameDataJson) {
        let jsonData = { courseware_id: NetWork.coursewareId, courseware_content: gameDataJson, is_result: 1, is_lavel: 0, lavel_num: 1 };
